...
from forms.openformtablelink2 import OpenFormTableLink2

class AbrirClienteServicos(Toplevel):
    ...
    def create_buttons(self):
        ...
        if self.classObjLink:
            ...
            text = "Minhas Reservas Associadas"
    ...
    def openlines(self):
        ...
        if obj != None:
            ...
            OpenFormTableLink2(self, self.classObjLink, self.attnamesLink,
